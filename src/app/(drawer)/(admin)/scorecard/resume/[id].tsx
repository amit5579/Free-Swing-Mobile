  ...
  return (
    ...
    >
      ...
      >
        ...
        {holes.length > 9 && (
          <View
            className={`${isDark ? "bg-[#1f1f1f]" : "bg-white"} rounded-xl overflow-hidden mb-4`}
            style={{
              shadowColor: "#000",
              shadowOffset: { width: 0, height: 2 },
              shadowOpacity: 0.1,
        ...
        <View className="mb-8">
          <View
            className={`flex-row p-4 rounded-xl ${isDark ? "bg-[#8BC34A]" : "bg-[#8BC34A]"}`}
            style={{
              shadowColor: "#000",
          ...
          >
            <Text className="flex-1 text-center font-bold text-white uppercase tracking-wider">
              Grand Total
            </Text>
            <Text className="flex-1" />
