          ...
          >
            ...
            >
              {hasProfileImage ? (
                <Image
                  source={{
                    uri: user.profilePictureUrl!.startsWith("http")
                      ? user.profilePictureUrl!
                      : `https://kolve18freeswing.com${user.profilePictureUrl}`,
                  }}
                ...
                <Text
                  style={{ fontSize: 28, fontWeight: "900", color: "#8BC34A" }}
                >
        ...
        >
          <HStack style={{ flexWrap: "wrap", justifyContent: "space-between" }}>
            {[
              ...
              >
                <Text
                  style={{ color: "#8BC34A", fontSize: 20, fontWeight: "900" }}
                >
                  {stat.value}
                </Text>
                <Text
        ...
        <VStack space="md">
          ...
          >
            ...
            >
              ...
              <Ionicons
                name={sections.account ? "chevron-up" : "chevron-down"}
                size={20}
                color="#8BC34A"
              />
            </TouchableOpacity>
          ...
          >
            ...
            >
              ...
              <Ionicons
                name={sections.golf ? "chevron-up" : "chevron-down"}
                size={20}
                color="#8BC34A"
              />
            </TouchableOpacity>
          ...
          >
            ...
            >
              ...
              <Ionicons
                name={sections.community ? "chevron-up" : "chevron-down"}
                size={20}
                color="#8BC34A"
              />
            </TouchableOpacity>
            {sections.community && (
              <View style={{ paddingHorizontal: 20, paddingBottom: 20 }}>
                ...
                {renderInfoRow(
                  "Posts Shared",
                  user.paradisePostCount?.toString() || "0",
                  "share-social-outline",
                )}
                {renderInfoRow(
                  "Photo Posts",
                  user.paradisePhotoPostCount?.toString() || "0",
                  "image-outline",
                )}
                {renderInfoRow(
                  "Latest Post",
                  user.lastParadisePostAt
                    ? new Date(user.lastParadisePostAt).toLocaleDateString(
                        "en-US",
