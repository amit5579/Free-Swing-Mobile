      ...
      >
        ...
        >
          {holes.map((h, index) => (
            <View
              key={h.holeId}
              className={`flex-row items-center p-3 ${index < holes.length - 1 ? (isDark ? "border-b border-[#333]" : "border-b border-gray-100") : ""}`}
            >
              <Text
        ...
        <View className="mt-6 mb-8 gap-y-2">
          <View
            className={`flex-row p-3 rounded-xl ${isDark ? "bg-[#262626]" : "bg-gray-100"}`}
          >
            <Text
              className={`flex-1 text-center font-bold text-xs ${isDark ? "text-white" : "text-black"}`}
            >
          ...
          <View
            className={`flex-row p-3 rounded-xl ${isDark ? "bg-[#8BC34A]" : "bg-[#8BC34A]"}`}
          >
