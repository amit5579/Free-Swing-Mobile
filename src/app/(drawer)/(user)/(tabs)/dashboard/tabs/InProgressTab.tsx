...
import { ActivityIndicator, useColorScheme, Pressable } from "react-native";
...
export function InProgressTab({
  ...
  return (
    <VStack space="md" className="pb-8 mt-0 pt-0">
      <HStack className="justify-between items-center px-4 mb-1">
        <VStack>
