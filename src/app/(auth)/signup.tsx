              ...
              {[1, 3, 6, 12].map((month) => (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    marginHorizontal: 2,
                    backgroundColor:
                      subscriptionMonths === month ? "#8bc34a" : "#e5e5e5",
                    alignItems: "center",
                    borderWidth: 1,
                    borderColor:
                      subscriptionMonths === month ? "#8bc34a" : "#ccc",
                  }}
                >
                  <Text
                    style={{
                      color: subscriptionMonths === month ? "#fff" : "#000",
                      fontSize: 12,
                      fontWeight: "600",
                    }}
                  >
            ...
            >
              ...
              {userType === "experienced" && (
                <>
                  ...
                  >
                    <Text
                      style={{ color: course ? "#000" : "rgba(0,0,0,0.4)" }}
                    >
                  ...
                  {course !== "" && (
                    <>
                      ...
                      >
                        <Text
                          style={{
                            color: selectedTeeBox ? "#000" : "rgba(0,0,0,0.4)",
                          }}
                        >
